...
const TopHeader = () => {
    return (
        <div className="bg-brand-surface text-white py-2">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-center text-sm">
                <div className="flex flex-col sm:flex-row items-center sm:space-x-6 space-y-2 sm:space-y-0 mb-3 sm:mb-0">
                    ...
                    <div className="flex items-center">
                        ...
                        <span>info@labminares.com</span>
                    </div>
                </div>
                <div className="flex items-center space-x-4">
                    <a href="https://www.facebook.com/people/Minares-South-SRL-Laboratorio-Qu%C3%ADmico-Metal%C3%BArgico/61572169857346/?mibextid=ZbWKwL" className="opacity-75 hover:opacity-100 transition-opacity" aria-label="Facebook" target='_blank'>
                        <FontAwesomeIcon icon={faFacebook} className="h-5 w-5" />
                    </a>
                    <a href="https://www.linkedin.com/company/minares-south-s-r-l/" className="opacity-75 hover:opacity-100 transition-opacity" aria-label="LinkedIn" target='_blank'>
                        <FontAwesomeIcon icon={faLinkedin} className="h-5 w-5" />
                    </a>
                    <a href="#" className="opacity-75 hover:opacity-100 transition-opacity" aria-label="Instagram">
                        <FontAwesomeIcon icon={faInstagram} className="h-5 w-5" />
                    </a>
                    <a href="https://www.tiktok.com/@minaressouth?_t=ZM-8tjJrVAFVQs&_r=1" className="opacity-75 hover:opacity-100 transition-opacity" aria-label="TikTok" target='_blank'>
